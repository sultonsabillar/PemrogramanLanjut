...
namespace CarRental
{
    ...
    SqlConnection Con = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=E:\SULTON\KULIAH\SEMESTER 7\PEMROGLANJUT\CarRental\CarRentaldb.mdf;Integrated Security=True;Connect Timeout=30");
